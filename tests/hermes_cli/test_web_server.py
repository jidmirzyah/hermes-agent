...
class TestWebServerEndpoints:
    ...
    # test_update_hermes_spawns_with_action_id intentionally dropped: it
    # mocks _spawn_hermes_action and expects update_hermes() to call it,
    # but this merge deliberately keeps update_hermes() on
    # _spawn_durable_action (F4's restart-independent, disk-tracked spawn
    # path — see _spawn_durable_action's own docstring). Adopting
    # upstream's _spawn_hermes_action call here would have silently
    # dropped the staged/applied distinction and restart-survival
    # guarantee this codebase was specifically built to provide.
