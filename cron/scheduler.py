        ...
        try:
            ...
            if blocked_config and not success:
                ...
                if success:
                    ...
                    # Record the durable job+error signature once. An operator
                    # acknowledgment suppresses repeat failure pings, while a
                    # new signature still carries the fork's streak nudge.
